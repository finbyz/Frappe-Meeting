...
frappe.ui.form.on('Meeting Schedule', {
	refresh: function(frm) {
		frm.add_custom_button(__("Create Meeting"), function() {
			frappe.model.open_mapped_doc({
				method : "meeting.meeting.doctype.meeting_schedule.meeting_schedule.make_meeting",
				frm : frm
			})
		})
	},
	...
	get_party_details: function(frm){
		frappe.call({
			method:"meeting.meeting.doctype.meeting_schedule.meeting_schedule.get_party_details",
			args:{
				party: frm.doc.party,
